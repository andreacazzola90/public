<?php
    ...
    $img_size = !empty($settings['img_size']) ? $settings['img_size'] : '442x602';
    ...
    $show_number = !empty($settings['show_number']) || false;
    $overlay = !empty($settings['overlay']) || false;
?>

<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-post-carousel pxl-service-carousel pxl-service-carousel5 <?php echo esc_attr($classes); ?>">
                                ...
                                <div class="pxl-post--inner <?php echo esc_attr($animate); ?>" data-wow-duration="1s">
                                    <?php if (!is_null($thumbnail)):?>
                                        <div class="pxl-post--featured">
                                            ...
                                            <?php endif; ?>
                                            <a class="pxl-item--link" href="<?php echo esc_url($post_link); ?>">
                                    ...
                                    <div class="pxl-post--content">
                                        <?php if($show_number) : ?>
                                            <?php foreach($numbers as $key=>$number) : ?>
                                                <?php if($post_key === $key): ?>
                                                    <div class="pxl-post--number"><?php echo esc_html('service '.$number); ?></div>
                                                <?php endif; ?>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                        ...
                                        <?php if($show_icon) : ?>
                                            <div class="pxl-post--icon">
                                                <a href="<?php echo esc_url($post_link); ?>" class="btn pxl-post--btn">
                                                    <i class="flaticon flaticon-plus-medium"></i>
                                                </a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <span class="pxl-post--line"></span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
