...
$img_size = !empty($img_size) ? $img_size : '410x485';
...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-service-carousel pxl-service-carousel3 <?php echo esc_attr($settings['l_service_style']) ?>">
            ...
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    <?php foreach ($posts as $key => $post) :
                        ...
                        if($show_icon == 'true' && $icon_type === 'icon' && !empty($icon_font)) $is_icon_normal = true;
                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-post--inner <?php echo esc_attr($pxl_animate); ?>" data-wow-duration="1.2s">
                                ...
                                <?php if ($show_image ==='true' && !is_null($thumbnail)): ?>
                                ...
                                <div class="pxl-post--holder">
                                    <?php if($is_icon_normal) : ?>
                                        <div class="pxl-post-icon">
                                            <i class="<?php echo esc_attr($icon_font); ?>"></i>
                                        </div>
                                    <?php endif; ?>

                                    <?php if($is_icon_image && !is_null($thumbnail_icon)) : ?>
                                        <div class="pxl-post--icon">
