...
$img_size = !empty($img_size) ? $img_size : '480x466';
...
$show_image = $widget->get_setting('show_image');
$opts = [
...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-service-carousel pxl-service-carousel4 pxl-swiper-nogap <?php echo esc_attr($settings['l_service_style']) ?>" >
                    ...
                    <?php foreach ($posts as $key => $post) :
                        ...
                        <div class="pxl-swiper-slide">
                            <?php if (!is_null($thumbnail)):?>
                                <div class="pxl-post--image"><?php echo wp_kses_post($thumbnail); ?></div>
                            <?php endif; ?>
                            <div class="pxl-post--container">
                                <div class="pxl-post--inner <?php echo esc_attr($pxl_animate); ?>" data-wow-duration="1.2s">
                                    ...
                                    <a href="<?php echo esc_url($post_link); ?>" class="btn pxl-post--btn pxl-btn-round pxl-btn-small pxl-btn-border pxl-btn-dark pxl-hover-default">
                                        <i class="flaticon flaticon-plus-normal"></i>
                                        <span class="pxl-btn--text"><?php echo esc_html__('View Details', 'gurus'); ?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
