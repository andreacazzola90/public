...
$show_divider_pagination = !empty($settings['show_divider_pagination']) ? 'pxl-divider' : '';
$opts = [
...
if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="pxl-swiper-slider pxl-testimonial-carousel pxl-testimonial-carousel2 <?php echo esc_attr($settings['l_style']) ?>">
                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
                                ...
                                <div class="pxl-content--top">
                                    ...
                                    <?php endif; ?>
                                    <div class="pxl-item--desc el-empty h5"><?php echo pxl_print_html($desc); ?></div>
                                    <!-- avatar -->
                                    <?php if ( !empty($value['avatar']['id']) ) : ?>               
                                        <?php $img_avatar  = pxl_get_image_by_size( array(
                                            'attach_id'  => $value['avatar']['id'],
                                            'thumb_size' => 'full',
                                        ));
                                        $thumbnail_avatar = $img_avatar['thumbnail']; ?>
                                        <div class="pxl-item--avatar">
                                            <?php echo pxl_print_html($thumbnail_avatar); ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
        ...
        <?php if(!empty($pagination)): ?>
            <div class="pxl-swiper-dots-wrap <?php echo esc_attr($pagination_style.' '.$show_divider_pagination); ?>">
