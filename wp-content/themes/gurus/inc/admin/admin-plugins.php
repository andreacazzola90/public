...
class Gurus_Admin_Plugins extends Gurus_Admin_Page {
	...
	public function __construct() {
		...
		$this->page_title = esc_html__( 'Install Plugins', 'gurus' );
		$this->menu_title = esc_html__( 'Install Plugins', 'gurus' );
		$this->parent = 'pxlart';
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
				$btn_class = 'white';
				$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'gurus' );
			...
			case 'installed':
				$btn_class = 'success';
				$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'gurus' );
			...
			case 'active':
				$btn_class = 'danger';
				$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'gurus' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'gurus' );
