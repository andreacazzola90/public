...
if (!class_exists('Gurus_Main')) { 
    class Gurus_Main extends Gurus_Base
    {
                ...
                if(is_array($page_opt) && is_array($theme_opt)){
                    foreach ($page_opt as $key => $value) {
                        if (empty($value) || $value === 'px') {
                            $page_opt[$key] = $theme_opt[$key] ?? $value;
                        }
                    }
                }
                $theme_opt = $page_opt;
