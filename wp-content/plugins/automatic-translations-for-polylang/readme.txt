...
= Version 1.4.15 | 24 June 2026 =
* **Fixed:**  Block translation issue with block Show templates.

= Version 1.4.14 | 15 June 2026 =
* **Improved:** Cleaned up the notice registration logic for better readability.

= Version 1.4.13 | 03 June 2026 =
* **Fixed:** Fixed JS error with ACF fields translation.
* **Fixed:** Fixed AutoPoly Custom Block post showing in search query and archive pages.
* **Improved:** Code improvements and optimization.

= Version 1.4.12 | 21 May 2026 =
* **Added:** Newly available core icon block arial label attribute translation support.
* **Added:** Core accordion heading block translation support.
* **Added:** Core file block download button text attribute translation support.
* **Added:** Core search block button text attribute translation support.
* **Tested up to:** WordPress 7.0.

= Version 1.4.11 | 05 May 2026 =
* **Added:** Elementor Atomic Widget translation support.
* **Tweaks:** Update readme screenshots.
